...
export declare class NodeFS implements AnyFS {
    private workingDir;
    ...
    appendFile(file: PathLike, data: any, options: {
        encoding?: string | null;
        mode?: number | string;
        flag?: string;
    } | string | null, callback: (err: NodeJS.ErrnoException | null) => void): void;
    appendFile(file: PathLike, data: any, callback: (err: NodeJS.ErrnoException | null) => void): void;
    ...
    readFile(path: PathLike, callback: (err: NodeJS.ErrnoException | null, data: Buffer) => void): void;
