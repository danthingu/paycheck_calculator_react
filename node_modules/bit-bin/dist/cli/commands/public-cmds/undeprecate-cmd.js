...
class Undeprecate {
  constructor() {
    (0, _defineProperty2().default)(this, "name", 'undeprecate <ids...>');
    (0, _defineProperty2().default)(this, "description", 'undeprecate a deprecated component (local/remote)');
    (0, _defineProperty2().default)(this, "alias", '');
    (0, _defineProperty2().default)(this, "opts", [['r', 'remote [boolean]', 'undeprecate a component from a remote scope']]);
  ...
  action([ids], {
    ...
    return (0, _consumer().undeprecate)({
      ids,
      remote
    });
  }
  ...
  report(deprecationResult) {
    ...
    const paintRemoved = bitIds => !_ramda().default.isEmpty(bitIds) && !_ramda().default.isNil(bitIds) ? _chalk().default.underline('undeprecated components:') + (0, _chalk().default)(` ${bitIds.join(', ')}\n`) : '';
