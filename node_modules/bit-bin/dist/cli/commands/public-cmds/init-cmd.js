...
class Init {
  ...
  action([path], flags) {
    ...
    if (harmony) (0, _featureToggle().addFeature)(_featureToggle().HARMONY_FEATURE);
    ...
    return (0, _consumer().init)(path, standalone, reset, resetHard, force, workspaceConfigFileProps).then(({
      created,
      addedGitHooks,
      existingGitHooks
    }) => {
