...
exports.findErrorDefinition = findErrorDefinition;
...
function _configKeyNotFound() {
  const data = _interopRequireDefault(require("../api/consumer/lib/exceptions/config-key-not-found"));

  _configKeyNotFound = function () {
    return data;
  };
...
function _extensionNameNotValid() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-name-not-valid"));
...
function _extensionLoadError() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-load-error"));
...
function _extensionGetDynamicPackagesError() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-get-dynamic-packages-error"));
...
function _extensionGetDynamicConfigError() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-get-dynamic-config-error"));
...
function _extensionInitError() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-init-error"));
...
function _extensionSchemaError() {
  const data = _interopRequireDefault(require("../legacy-extensions/exceptions/extension-schema-error"));
...
function _addingIndividualFiles() {
  const data = require("../consumer/component-ops/add-components/exceptions/adding-individual-files");
...
function _incorrectRootDir() {
  const data = _interopRequireDefault(require("../consumer/component/exceptions/incorrect-root-dir"));
...
function _outsideRootDir() {
  const data = _interopRequireDefault(require("../consumer/bit-map/exceptions/outside-root-dir"));
...
function _failedLoadForTag() {
  const data = require("../consumer/component/exceptions/failed-load-for-tag");
...
function _cli() {
  const data = require("../extensions/cli");
...
var _default = err => {
  ...
  const getErrMsg = () => {
    if (err instanceof _cli().PaperError) {
      return err.report();
    }
  ...
  _logger().default.silly(err.stack); // eslint-disable-next-line no-console
