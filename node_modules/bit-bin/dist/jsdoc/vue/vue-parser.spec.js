...
describe('Vue docs Parser', () => {
  describe('Invalid code', () => {
    it('should returns an empty object', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
      const doclets = (yield (0, _().default)('this is an invalid code'))[0];
  ...
  describe('parse()', () => {
    ...
    before( /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
      ...
      doclet = (yield (0, _().default)(componentFileContent, componentFile))[0];
    }));
