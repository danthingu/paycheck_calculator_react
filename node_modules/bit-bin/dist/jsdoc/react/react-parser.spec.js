...
describe('React docs Parser', () => {
  describe('parse()', () => {
    describe('Invalid code', () => {
      it('should returns an empty array', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
    ...
    describe('React Docs', () => {
      ...
      before( /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
        ...
        const doclets = yield (0, _().default)(_fsExtra().default.readFileSync(file).toString()); // @ts-ignore
