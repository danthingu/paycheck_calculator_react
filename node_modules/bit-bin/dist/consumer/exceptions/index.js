...
Object.defineProperty(exports, "ComponentSpecsFailed", {
  enumerable: true,
  get: function () {
    return _componentSpecsFailed().default;
  }
});
Object.defineProperty(exports, "MissingDependencies", {
  enumerable: true,
  get: function () {
    return _missingDependencies().default;
  }
});
...
function _componentSpecsFailed() {
  const data = _interopRequireDefault(require("./component-specs-failed"));
...
function _missingDependencies() {
  const data = _interopRequireDefault(require("./missing-dependencies"));

  _missingDependencies = function () {
    return data;
  };
