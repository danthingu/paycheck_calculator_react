...
class ComponentMap {
  ...
  getTrackDir() {
    if (this.origin === _constants().COMPONENT_ORIGINS.AUTHORED) return this.rootDir || this.trackDir;
  ...
  doesAuthorHaveRootDir() {
    return Boolean(this.origin === _constants().COMPONENT_ORIGINS.AUTHORED && this.rootDir);
  }
  /**
  ...
  trackDirectoryChanges(consumer, id) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      const trackDir = _this.getTrackDir();
      ...
      if (trackDir) {
        ...
        const numOfFilesBefore = _this.files.length;
        const addContext = {
          consumer
        };
        ...
        if (_this.files.length > numOfFilesBefore) {
