...
describe('ComponentList', function () {
  ...
  describe('listLocalScope', function () {
    ...
    it('should return results with the correct id', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
    ...
    it('should return results with the correct deprecated status', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
  ...
  describe('listScope', () => {
    ...
    it('should return results with the correct id', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
      ...
      scope.list = /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
