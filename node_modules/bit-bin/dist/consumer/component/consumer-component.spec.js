...
describe('ConsumerComponent', function () {
  ...
  describe('fromString()', () => {
    describe('component with compiler', () => {
      ...
      it('should not crash and return a ConsumerComponent Object', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
  ...
  describe('docs', () => {
    ...
    it('should return the docs when a file has a jsdoc block', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
      const src = `/**
    ...
    it('should return the docs only for non-test files with jsdocs', /*#__PURE__*/(0, _bluebird().coroutine)(function* () {
      const src = `/**
      * is a given variable a string
      */
      function isString() {}`; // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
