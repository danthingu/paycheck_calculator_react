...
const debug = require('debug')('tree'); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!


const fs = require('fs'); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
...
module.exports._getDependencies = function (config) {
  ...
  precinctOptions.includeCore = false; // @ts-ignore
  ...
  dependencies.forEach(dependency => processDependency(dependency)); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  ...
  function processDependency(dependency) {
    ...
    pathMapDependencies.push(pathMap); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
