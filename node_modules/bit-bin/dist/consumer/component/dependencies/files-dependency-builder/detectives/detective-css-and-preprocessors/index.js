...
function extractDependencies(importStatementNode) {
  ...
  if (importStatementNode.prelude.type === 'AtrulePrelude' && importStatementNode.prelude.children.tail.data.type === 'Url') {
    return importStatementNode.prelude.children.tail.data.value.value.replace(/["']/g, '');
  } // simple @import


  if (importStatementNode.prelude.type === 'AtrulePrelude' && importStatementNode.prelude.children && importStatementNode.prelude.children.tail.data.type !== 'Url') {
