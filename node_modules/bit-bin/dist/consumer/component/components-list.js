...
class ComponentsList {
  ...
  listModifiedComponents(load = false) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      if (!_this4._modifiedComponents) {
        ...
        const componentStatuses = yield _this4.consumer.getManyComponentsStatuses(fileSystemComponents.map(f => f.id));
        _this4._modifiedComponents = fileSystemComponents.filter(component => {
  ...
  listOutdatedComponents() {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      return fileSystemComponents.filter(component => {
        ...
        const latestVersion = modelComponent.latest(); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
  ...
  updateIdsFromModelIfTheyOutOfSync(ids) {
    ...
    return (0, _bluebird().coroutine)(function* () {
      ...
      const updatedIdsP = ids.map( /*#__PURE__*/function () {
