...
export default class SourceFile extends AbstractVinyl {
    ...
    static load(filePath: PathOsBased, base: PathOsBased, consumerPath: PathOsBased, extendedProps: Record<string, any>): SourceFile | null;
    ...
    static loadFromSourceFileModel(file: SourceFileModel, repository: Repository): Promise<SourceFile>;
    clone(): this;
}
