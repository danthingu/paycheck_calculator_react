...
class ScopesData {
  ...
  constructor(scopesOptions) {
    ...
    this.setLocalScope();
    this.setRemoteScope(scopesOptions === null || scopesOptions === void 0 ? void 0 : scopesOptions.remoteScopeWithDot);
    this.setEnvScope();
  ...
  setRemoteScope(remoteScopeWithDot = false) {
    if (remoteScopeWithDot) {
      this.remote = `${(0, _utils().generateRandomStr)()}.${(0, _utils().generateRandomStr)()}-remote`;
    } else {
