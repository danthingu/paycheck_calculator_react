...
function loadHooks(scopePath, scopeJson) {
  ...
  if (hooksPath) {
    const hooksFinalPath = (0, _isRelativePath().default)(hooksPath) ? _path().default.join(scopePath, hooksPath) : hooksPath; // eslint-disable-next-line global-require, import/no-dynamic-require
