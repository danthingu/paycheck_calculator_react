...
export declare class StylableTransformer {
    ...
    scopeSelector(originMeta: StylableMeta, selector: string, metaExports?: Pojo<string>, scopeRoot?: boolean, calcPaths?: boolean, rule?: postcss.Rule): ScopedSelectorResults;
