...
var StylableTransformer = /** @class */ (function () {
    ...
    StylableTransformer.prototype.transform = function (meta) {
        ...
        if (this.optimize) {
            utils_1.deprecated('StylableTransformer optimize is deprecated. Use new StylableOptimizer');
        ...
        meta.imports.forEach(function (_import) {
            if (_import.theme) {
                var resolved = _this.resolver.deepResolve({
                    ...
                    name: 'default',
                    import: _import,
                    context: path_1.dirname(meta.source)
                });
    ...
    StylableTransformer.prototype.scopeSelector = function (originMeta, selector, metaExports, scopeRoot, calcPaths, rule) {
        var _this = this;
        if (scopeRoot === void 0) { scopeRoot = false; }
