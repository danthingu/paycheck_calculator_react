...
var Stylable = /** @class */ (function () {
    function Stylable(projectRoot, fileSystem, requireModule, delimiter, onProcess, diagnostics, hooks, scopeRoot, resolveOptions, optimizer, resolveNamespace) {
    ...
    Stylable.create = function (config) {
        ...
        }, config.delimiter, config.onProcess, config.diagnostics, config.hooks, config.scopeRoot, config.resolveOptions, config.optimizer, config.resolveNamespace);
    };
