...
describe('Stylable postcss transform (Scoping)', function () {
    describe('scoped pseudo-elements', function () {
        ...
        it('class selector that extends root with inner class targeting (deep)', function () {
            ...
            chai_1.expect(result.nodes[1].selector).to.equal('.ns--app.ns1--root .ns1--inner');
        ...
        it('class selector that extends root uses pseudo-element after pseudo-class', function () {
            ...
            chai_1.expect(result.nodes[1].selector).to.equal('.ns--app.ns1--root:hover .ns1--inner');
        });
        it('resolve and transform pseudo-element from deeply extended type', function () {
            ...
            chai_1.expect(result.nodes[1].selector).to.equal('.ns--app.ns1--root .ns2--deep');
        });
        it('resolve and transform pseudo-element from deeply override rather then extended type', function () {
            ...
            chai_1.expect(result.nodes[1].selector).to.equal('.ns--app.ns1--root .ns1--deep');
        });
    ...
    describe('scoped classes', function () {
        ...
        it('scope selector that extends anther style', function () {
            ...
            chai_1.expect(result.nodes[0].selector).to.equal('.entry--a.imported--root');
        });
        it('scope selector that extends a style with -st-global root', function () {
            ...
            chai_1.expect(result.nodes[0].selector).to.equal('.entry--a.x');
        });
        ...
        it('scope selector that extends local class', function () {
            ...
            chai_1.expect(result.nodes[1].selector).to.equal('.ns--b.ns--a');
        });
        it('extends class form imported sheet', function () {
            ...
            chai_1.expect(result.nodes[0].selector).to.equal('.ns--a.ns1--b');
        });
